<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
        <div>
            <h2 class="text-2xl font-bold text-gray-900 tracking-tight">Tambah Jurusan</h2>
            <p class="text-sm text-gray-500 mt-1">Buat kompetensi keahlian baru.</p>
        </div>
        <a href="{{ route('jurusan.index') }}" class="inline-flex items-center px-4 py-2 bg-white border border-gray-300 rounded-xl text-sm font-medium text-gray-700 hover:bg-gray-50 hover:text-indigo-600 transition shadow-sm"><x-heroicon-o-arrow-left class="w-4 h-4 mr-2" /> Kembali</a>
    </div>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 sm:p-8">
                ...
                <div class="space-y-6">
                    <div class="relative group">
                        ...
                        <label class="input-label">Nama Jurusan (Contoh: Rekayasa Perangkat Lunak)</label>
                    ...
                    <div class="relative group">
                        ...
                        <label class="input-label">Kode Singkatan (Contoh: RPL)</label>
                ...
                <div class="pt-8 mt-6 border-t border-gray-100">
                    <button type="submit" class="w-full px-6 py-3 bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-xl font-semibold hover:from-indigo-700 hover:to-purple-700 transition shadow-lg shadow-indigo-200 flex items-center justify-center gap-2">
                        <x-heroicon-o-check class="w-5 h-5" /> Simpan Jurusan
                    </button>
                </div>
            </div>
        </form>
