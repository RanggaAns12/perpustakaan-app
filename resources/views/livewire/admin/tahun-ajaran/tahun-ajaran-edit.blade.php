<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
        <div>
            <h2 class="text-2xl font-bold text-gray-900 tracking-tight">Edit Periode</h2>
    ...
    <div class="max-w-2xl mx-auto">
        <form wire:submit="update">
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 sm:p-8">
                ...
                <div class="space-y-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="relative group">
                            <input type="text" wire:model="tahun_ajaran" class="input-field peer" placeholder=" " />
                            <label class="input-label">Tahun Ajaran (Contoh: 2024/2025)</label>
                            @error('tahun_ajaran') <span class="text-red-500 text-xs mt-1">{{ $message }}</span> @enderror
                        </div>

                        {{-- Semester --}}
                        <div class="relative group">
                            <select wire:model="semester" class="input-field peer appearance-none cursor-pointer">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="relative group">
                            <input type="date" wire:model="tanggal_mulai" class="input-field peer" placeholder=" " />
                        ...
                        <div class="relative group">
                            <input type="date" wire:model="tanggal_selesai" class="input-field peer" placeholder=" " />
                    ...
                    <div class="flex items-center justify-between p-4 bg-gray-50 rounded-xl border border-gray-200">
                        <div>
                            ...
                            <span class="text-xs text-gray-500">Set sebagai periode berjalan saat ini?</span>
                        </div>
                ...
                {{-- Tombol Action (Yang Sebelumnya Hilang) --}}
                <div class="flex justify-end gap-4 pt-8 mt-4 border-t border-gray-100">
                    ...
                    <button type="submit" class="px-6 py-3 bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-xl font-semibold hover:from-indigo-700 hover:to-purple-700 transition shadow-lg shadow-indigo-200 flex items-center gap-2">
                        <x-heroicon-o-check class="w-5 h-5" /> Edit Periode
                    </button>
                </div>
