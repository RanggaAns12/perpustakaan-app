<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
        <div>
            <h2 class="text-2xl font-bold text-gray-900 tracking-tight">Tambah Penulis</h2>
            <p class="text-sm text-gray-500 mt-1">Tambahkan data penulis baru ke dalam database.</p>
        </div>
        ...
        <form wire:submit="save">
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 sm:p-8">
                ...
                <h3 class="text-lg font-semibold text-gray-800 mb-6 flex items-center gap-2">
                    <div class="w-8 h-8 bg-indigo-100 rounded-lg flex items-center justify-center text-indigo-600"><x-heroicon-o-pencil class="w-5 h-5" /></div>
                    Data Diri Penulis
                </h3>
                ...
                <div class="flex justify-end gap-4 pt-8 mt-4 border-t border-gray-100">
                    ...
                    <button type="submit" class="px-6 py-3 bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-xl font-semibold hover:from-indigo-700 hover:to-purple-700 transition shadow-lg shadow-indigo-200 flex items-center gap-2">
                        <x-heroicon-o-check class="w-5 h-5" /> Simpan Data
                    </button>
                </div>
            </div>
        </form>
